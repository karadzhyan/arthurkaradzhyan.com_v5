...
var industriesRaw = [
  {
    ...
    situation: "Hotels and restaurants operate 24/7, guest-facing environments with hundreds of hourly employees generating extensive time-clock data every shift. Operational realities — skeleton night crews, banquet rushes, front desk coverage — make it genuinely difficult to provide 30-minute duty-free meal periods while maintaining service levels. This is not corner-cutting; it is the structural reality of the business model.",
    complication: "The Donohue v. AMN Services presumption transforms that time-clock data into a litigation weapon. Every meal punch under 30 minutes — including voluntary early returns — creates a rebuttable presumption that the employer failed to provide a compliant meal period. Hotels generate hundreds or thousands of these entries per PAGA period, and the employer must rebut each one with affirmative evidence, employee by employee, shift by shift. The 'relieved of all duties' standard under Brinker directly conflicts with guest-facing service: a front desk employee who responds to an approaching guest during a break has arguably had their meal period interrupted. The Brinker 'provide not ensure' framework helps, but it shifts the burden — it does not eliminate the exposure.",
    ...
    exposureCategories: [
      {
        ...
        severity: "critical",
        priority: "Immediate",
        impact: "The single highest-exposure violation category in hospitality. Every short meal punch in the time-clock data creates a rebuttable presumption of violation — and hotels generate thousands of them per PAGA period.",
      ...
      },
      {
        ...
        severity: "high",
        priority: "Short-term",
        impact: "Mischaracterizing a service charge as a gratuity — or vice versa — creates both individual claims and PAGA penalty exposure. The supervisor classification trap compounds the risk.",
      ...
      },
      {
        ...
        severity: "critical",
        priority: "Immediate",
        impact: "200 employees × 7 minutes/shift × 5 shifts/week × 52 weeks = 60,000+ compensable hours/year. At $18/hour, annual wage exposure alone exceeds $1M before overtime premiums or PAGA penalties.",
      ...
      },
      {
        ...
        severity: "moderate",
        priority: "Ongoing",
        impact: "For minimum-wage employees, the premium is always owed when the split-shift pattern exists. The 'already compensated' offset narrows exposure for higher-paid staff but does not eliminate the tracking obligation.",
      ...
      },
      {
        ...
        severity: "high",
        priority: "Short-term",
        impact: "Every 'working manager' who spends more than 50% of the day on non-exempt tasks — serving, cleaning, covering shifts — is misclassified, creating retroactive overtime liability for every affected pay period.",
      ...
      },
      {
        ...
        severity: "high",
        priority: "Short-term",
        impact: "One operational gap generates three independent penalty streams: the underlying underpayment, a derivative wage statement violation, and a PAGA default penalty. The cascading effect is unique to piece-rate compensation.",
  ...
  },
  {
    ...
    situation: "Dealership compensation is built around commission timing: a salesperson closes a deal (negotiates price, gets signatures, hands off to F&I), but the commission is not paid until the financing funds — which can take weeks. Most dealership commission plans forfeit the commission if the salesperson departs between closing and funding. This timing gap is the structural norm across the industry.",
    complication: "Under Sciborski v. Pacific Bell Directory, commissions are earned when the employee completes the work — at deal closing, not deal funding. Conditioning payment on continued employment through funding constitutes unlawful forfeiture. Every departed salesperson with a pending deal is a claimant, and a single departure cascades into three independent penalty streams: unpaid wages (§ 200-204), waiting time penalties (§ 203, up to 30 days of daily wages), and wage statement violations (§ 226). A dealership with 20% annual salesperson turnover generates 8-12 claimants per year. The supervising partner on one analysis — a senior wage-and-hour practitioner with decades of experience — noted he had never seen the Sciborski forfeiture theory raised in his practice. The exposure is industry-wide and largely undefended.",
    ...
    exposureCategories: [
      {
        ...
        severity: "critical",
        priority: "Immediate",
        impact: "A single departed salesperson with one pending deal generates $15,000-$25,000 in combined exposure. With 10-15 departures per year at a mid-size dealership, annual exposure from this theory alone reaches $200,000+.",
      ...
      },
      {
        ...
        severity: "high",
        priority: "Short-term",
        impact: "Exemption failure in any single workweek triggers overtime liability for that week — and dealerships that verify monthly or quarterly instead of weekly are systematically mispricing the exemption across slow sales periods.",
      ...
      },
      {
        ...
        severity: "high",
        priority: "Short-term",
        impact: "Most dealership payroll systems calculate flat-rate overtime incorrectly. The regular rate must use actual hours worked — not flag hours — and non-productive time must be separately compensated and itemized on the wage statement.",
      ...
      },
      {
        ...
        severity: "high",
        priority: "Short-term",
        impact: "Payroll systems typically understate the regular rate by 40-60% by excluding spiffs, CSI bonuses, holdbacks, and volume escalators. Every overtime hour and every meal/rest premium is underpaid by the difference.",
      ...
      },
      {
        ...
        severity: "moderate",
        priority: "Ongoing",
        impact: "The administrative exemption is vulnerable because the actual F&I workflow is heavily scripted — plaintiff's counsel will characterize portal processing and documentation as production work, not discretionary judgment.",
      ...
      },
      {
        ...
        severity: "moderate",
        priority: "Ongoing",
        impact: "Dealerships that set the base salary too high to attract talent inadvertently push commission below the 50% threshold, destroying the overtime exemption for every affected workweek.",
  ...
  },
  {
    ...
    situation: "Healthcare staffing agencies supply nurses, CNAs, therapists, and clinical staff to hospitals and skilled nursing facilities that the agency does not own, operate, or control. The agency is the employer of record. CDPH staffing ratios create scheduling constraints that make compliant meal period provision structurally difficult at many client facilities.",
    complication: "The staffing agency bears the PAGA penalty for violations it cannot prevent. When a county hospital's charge nurse tells a staffing agency nurse she cannot leave the floor for a meal break because the unit is at minimum staffing, the staffing agency is liable — despite having no authority to change the facility's scheduling practices. No published decision addresses how PAGA penalties should be allocated between joint employers, leaving the staffing firm fully exposed for the client facility's operational decisions.",
    ...
    exposureCategories: [
      {
        ...
        severity: "critical",
        priority: "Immediate",
        impact: "No published decision addresses PAGA penalty allocation between joint employers — the staffing firm bears 100% of the penalty burden for violations caused by client facility operational decisions it cannot control.",
        analysis: "Martinez established a three-part test for employment: (1) exercise control over wages, hours, or working conditions, (2) suffer or permit to work, or (3) engage, thereby creating a common law employment relationship. In staffing arrangements, both the staffing agency and the client facility may satisfy one or more prongs, creating joint employer liability. The allocation question is the central defense challenge: the staffing firm controls payroll, wage statements, and timely payment, but the client facility controls scheduling, meal period timing, rest period availability, and overtime authorization.\n\nThe novel defense developed in one healthcare staffing matter argued that where violations arise from working conditions controlled by an immune public agency employer, and the staffing firm is a secondary employer without operational authority over those conditions, PAGA penalties should not attach to the staffing firm for those specific violation categories. This required a two-track analysis: violations attributable to the staffing firm's own obligations (wage statements, timely payment, expense reimbursement) versus violations attributable to the client facility's operations (meal timing, rest period scheduling, overtime from facility-mandated shift extensions). The staffing firm concedes and remediates the first track; it contests penalty liability for the second.",
        defenseStrategy: "Document the allocation of operational control between the staffing agency and each client facility. Build a facility-by-facility matrix showing which entity controls scheduling, meal period timing, rest period availability, and overtime authorization. Use this matrix to argue that penalties should be allocated to the entity that controlled the conditions generating the violation. For government client facilities, develop the public agency immunity defense — if the client is a county hospital or state facility immune from PAGA, the penalties should not flow through to the staffing firm as a pass-through of the agency's immune conduct."
      },
      {
        ...
        severity: "critical",
        priority: "Immediate",
        impact: "A unified PAGA claim across 14 client locations with different scheduling software, break protocols, staffing ratios, and patient acuity levels treats fundamentally different workplaces as interchangeable — the manageability defense is strongest here.",
        analysis: "A staffing firm placing employees at 14 different client locations, each with different scheduling practices, break policies, supervisory structures, and patient care requirements, creates individualized proof requirements that representative treatment cannot adequately address. The meal period compliance environment at a Level I trauma center — where patient acuity demands continuous monitoring and break relief requires a qualified replacement nurse — is categorically different from the environment at an outpatient rehabilitation clinic where patient load is scheduled and predictable.\n\nEstrada reinforced the court's authority to ensure that PAGA claims are manageable. The § 2699(p) manageability inquiry asks whether the claims can be adjudicated in a manner that is fair and efficient. For a staffing firm operating across 14 facilities: each facility uses different scheduling software (Kronos at one, ADP at another, paper timesheets at a third), each has different break relief protocols (dedicated relief nurse at some, charge nurse coverage at others, no formal protocol at rural clinics), and each presents different staffing ratio constraints that dictate when breaks can occur. Representative testimony from one facility tells the court nothing about compliance at another.",
        defenseStrategy: "Build the manageability motion under § 2699(p) around facility-specific evidence: different scheduling software, different break relief protocols, different staffing ratios, different patient acuity levels. Create a facility comparison matrix — a visual exhibit showing the operational differences across all client locations. Demonstrate that assessing liability requires facility-by-facility, shift-by-shift analysis that representative treatment cannot accommodate. Propose a bellwether or phased trial structure as an alternative to full representative adjudication."
      },
      {
        ...
        severity: "high",
        priority: "Short-term",
        impact: "Every same-day multi-facility assignment generates compensable inter-facility travel time. If unpaid, this travel also pushes total daily hours beyond 8, triggering overtime exposure on top of the base wage claim.",
        analysis: "Healthcare workers who travel between client locations during the workday — a traveling nurse who works a morning shift at one hospital and an afternoon shift at another — have a strong argument that the inter-facility travel time is compensable under Morillion. The distinction turns on whether the employer 'requires' the travel: if the staffing agency assigns the employee to two facilities in one day, the travel between them is employer-directed and compensable. Home-to-first-facility and last-facility-to-home travel is generally not compensable as ordinary commute time.\n\nThe overtime compounding effect is significant. A nurse assigned to a 7:00 AM–3:00 PM shift at Hospital A and a 4:00 PM–12:00 AM shift at Hospital B has 1 hour of inter-facility travel time. If that hour is compensable, total daily hours are 17 (8 + 1 + 8), generating 9 hours of overtime. If the staffing firm pays only for the two 8-hour shifts, the unpaid travel time creates both a straight-time wage claim and a derivative overtime claim. Across a workforce of traveling nurses with regular multi-facility assignments, the aggregate exposure compounds rapidly.",
        defenseStrategy: "Audit scheduling records to identify all same-day multi-facility assignments across the PAGA period. Calculate compensable travel time for each assignment and verify whether travel time was paid. Map the overtime impact — how many additional overtime hours result from adding the travel time to daily totals. If systematic underpayment exists, quantify it precisely for each employee to build the three-scenario exposure model."
      },
      {
        name: "On-Call and Standby Compensation",
        statute: "Lab. Code § 510; Mendiola v. CPS Security Solutions (2015) 60 Cal.4th 833",
        severity: "high",
        priority: "Short-term",
        impact: "The engaged-to-wait vs. waiting-to-engage distinction determines whether on-call hours are compensable. Healthcare staffing firms that require nurses to remain within a response radius or carry a pager during off-hours may owe wages for the entire on-call period.",
        analysis: "Mendiola held that on-call time is compensable when the employer's restrictions on the employee's activities are so substantial that the employee cannot use the time effectively for personal purposes. The healthcare staffing context creates a spectrum: a nurse required to remain within 30 minutes of a client facility, carry a pager, and respond immediately to staffing shortages is arguably 'engaged to wait' — the geographic restriction and response requirement prevent meaningful personal use of the time. A nurse who is merely on a callback list and free to engage in personal activities until called is 'waiting to be engaged' — non-compensable.\n\nThe critical factual inquiry is the degree of restriction: geographic radius requirements, response time mandates, frequency of actual callbacks, and whether the nurse can decline a call without consequence. Staffing firms that impose tight restrictions without compensating the on-call time create per-shift, per-nurse PAGA exposure. The exposure scales with the number of nurses on on-call rotation and the number of on-call shifts per PAGA period.",
        defenseStrategy: "Audit on-call policies and practices for each client facility assignment. Map the actual restrictions: response time requirements, geographic radius, callback frequency, consequences for declining. For restrictions that cross the Mendiola line, compensate the on-call time prospectively and calculate historical exposure. For restrictions that fall on the 'waiting to be engaged' side, document the employee's freedom to use the time for personal purposes."
      },
      {
        name: "Per Diem and Expense Reimbursement",
        statute: "Lab. Code § 2802; Gattuso v. Harte-Hanks Shoppers (2007) 42 Cal.4th 554",
        severity: "moderate",
        priority: "Ongoing",
        impact: "Traveling healthcare workers incur lodging, meals, and transportation costs that are 'necessary expenditures incurred in direct consequence of the discharge of their duties.' Failure to reimburse creates per-employee, per-pay-period PAGA exposure across the entire traveling workforce.",
        analysis: "Section 2802 requires employers to reimburse employees for all necessary expenditures incurred in direct consequence of the discharge of their duties. For traveling healthcare workers — nurses, therapists, and technicians assigned to client facilities away from their home base — this includes lodging, meals, transportation, and incidental travel expenses. Many staffing firms provide a per diem that may not cover actual costs, or condition reimbursement on documentation requirements that effectively discourage claims.\n\nThe adequacy of the per diem is the central question. A flat $150/day per diem for a nurse assigned to a San Francisco hospital — where hotel rates routinely exceed $250/night — is arguably inadequate under § 2802. The employer bears the burden of demonstrating that the reimbursement reasonably covers the actual expenses incurred. Staffing firms that set per diem rates based on national averages rather than location-specific costs create a systematic underpayment across every assignment in high-cost markets.",
        defenseStrategy: "Audit per diem rates against actual costs in each assignment market. Implement location-adjusted per diem schedules (GSA rates provide a defensible benchmark). Ensure reimbursement policies do not impose documentation requirements that effectively discourage legitimate claims. For historical exposure, calculate the per-employee shortfall between per diem paid and actual costs incurred."
      },
      {
        name: "Exempt Classification for Traveling Nurses",
        statute: "Lab. Code § 515(a); IWC Wage Order 4, § 1(A)(3)(e)",
        severity: "moderate",
        priority: "Ongoing",
        impact: "The professional exemption requires that the nurse 'customarily and regularly exercise discretion and independent judgment.' Traveling nurses who follow facility-specific protocols without authority to deviate may fail the duties test — creating retroactive overtime exposure for every assignment.",
        analysis: "Registered nurses are commonly classified as exempt under the professional exemption, which requires a license, specialized intellectual instruction, and the customary and regular exercise of discretion and independent judgment. For staff nurses at a single employer, this classification is generally defensible — nursing judgment is inherent in patient care. But traveling nurses present a nuanced question: the nurse follows the client facility's protocols, the client facility's attending physicians issue the orders, and the nurse's discretion is bounded by the specific facility's procedures and scope-of-practice limitations.\n\nPlaintiff's counsel will argue that a traveling nurse who rotates through different facilities every 8-13 weeks, following each facility's predetermined protocols, is executing tasks rather than exercising independent professional judgment. The defense must demonstrate that nursing judgment — patient assessment, triage decisions, medication administration decisions, care plan modifications — is inherent in the work regardless of the facility assignment. The strength of this defense varies by specialty: ICU and ER nurses exercise substantially more independent judgment than med-surg or post-op floor nurses following standardized recovery protocols.",
        defenseStrategy: "Conduct a specialty-by-specialty duties analysis for traveling nurse positions. Document the clinical judgment exercised at each assignment — patient assessments, triage decisions, care plan modifications — to demonstrate that the professional exemption is satisfied regardless of facility rotation. For specialties where the exemption is weaker (standardized protocol-driven roles), evaluate reclassification and calculate historical overtime exposure."
      }
    ],
  ...
  },
  {
    ...
    situation: "Solar installers routinely work four 10-hour days under a 4/10 alternative workweek schedule (AWS). Field crews report to an employer-designated yard, pick up equipment and vehicles, and drive to remote installation sites. Piece-rate compensation (per panel, per system) is common for installation crews.",
    complication: "The DIR election process has four mandatory steps — written disclosure, meeting, secret ballot, DIR filing — and missing any single step, even a procedural technicality like a late DIR filing, invalidates the entire AWS retroactively to inception. For a crew of 30 installers working under an invalid AWS for two years, 2 hours of daily overtime × 4 days/week × 104 weeks = 24,960 overtime hours, exceeding $500,000 in exposure before PAGA penalties. Travel time from yard to site compounds this: it pushes total daily hours beyond 8 even before installation work begins.",
  ...
  },
  {
    ...
    situation: "Technology companies classify engineers, PMs, and QA staff as exempt under the computer professional exemption (§ 515.5) or administrative exemption. Post-COVID, most shifted to remote or hybrid models. Compensation includes salary, RSUs, stock options, and performance bonuses — creating a complex regular rate calculation.",
    complication: "The § 515.5 computer professional exemption requires 'intellectual or creative work requiring discretion and independent judgment' — not merely important technical work. QA engineers following predefined specifications, IT support staff following established protocols, and PMs doing organizational rather than technical work all fail the duties test. Every misclassified employee generates overtime, meal, and rest period exposure for every workweek. The remote work shift created a parallel § 2802 exposure: companies that never implemented reimbursement policies for home internet, cell phone, and equipment have per-employee, per-pay-period PAGA violations scaling with workforce size.",
  ...
  },
  {
    ...
    situation: "Agricultural operations employ large workforces (often 100+ employees) compensated on piece-rate — per bin, per row, per acre — using payroll systems that predate § 226.2's separate-compensation requirements. Seasonal hiring cycles create final pay timing complexity, and field operations often lack adequate rest period tracking.",
    complication: "Section 226.2 requires that piece-rate employers separately compensate rest/recovery periods at a regular rate derived from piece-rate earnings and separately identify this payment on the wage statement. Legacy payroll systems cannot perform this calculation. The result is systematic underpayment embedded in every pay period for every field worker, compounding across years. One calculation gap generates three independent penalty streams: the underlying underpayment, a derivative wage statement violation (§ 226), and PAGA penalties. With 100+ aggrieved employees, the aggregate exposure dwarfs other industries.",
