    ...
    <div style={{background:"#fff",border:"1px solid #e0e0e0",padding:40,position:"relative",overflow:"hidden",marginTop:32}}>
      ...
      {totalScore>0&&<div style={{padding:24,background:"#f8faf9",border:"1px solid #e0e8e6",marginBottom:16}}>
        ...
        {pct>=75&&<div>
          ...
          <S fontSize={12} lineHeight="1.8" color="#555" marginBottom={12}>Your documentation record supports {capLabel} cap qualification. At mediation, present the penalty cap documentation package as a single organized binder (see the Penalty Cap Qualification Tracker in Resources for the 10-tab structure). Lead with the written remediation plan signed by a senior executive — this signals organizational commitment. The timeline showing every remediation action plotted against the {track==="pre"?"notice date":"60-day deadline"} is the single most persuasive visual tool in the package.</S>
        ...
        {pct<45&&<div>
          ...
          <S fontSize={12} lineHeight="1.8" color="#555">If the matter is pre-notice: you have time. Complete the Pre-PAGA Compliance Audit (Resources section), build the 90-day remediation timeline, and reach 15% cap positioning before a notice arrives. If post-notice: the 60-day window is your last opportunity for the 30% cap. Every day of inaction is documented evidence of inaction.</S>
        </div>}
      </div>}
